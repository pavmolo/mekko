...
def calculate_font_size(width_percent, height_percent, text_length):
    ...
    char_width = 4
    char_height = 20
    font_size_by_width = block_width_px / (text_length * char_width) * 2 * 0.4
...
if uploaded_file:
    ...
    recommendations_descriptions = {
        ...
        "Весомый конкурент": "Ваша компания является одним из ключевых игроков на рынке, но не доминирует. Это может требовать усиленных усилий для удержания вашей позиции и противостояния конкурентам. Рассмотрите стратегии для увеличения вашей доли или удержания текущей позиции.",
